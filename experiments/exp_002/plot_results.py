"""
exp_002/plot_results.py  —  Generate figures for selected exp_002 scenarios.
...
Output: LAB_PC_DRIVE/exp_002/<label>/  (one subfolder per scenario, 6 PNG each)
        LAB_PC_DRIVE/exp_002/peak_pressure_comparison.<fmt>
...
OUT_ROOT    = r'C:\Users\SYAVAS-LASERLAB\Documents\LAB_PC_DRIVE\exp_002'
...
def fig_peak_pressure_comparison(dpi=300):
    """
    ...
    ax.set_title('exp_002 — Peak PA Pressure vs Scenario')
...
def parse_args():
    p = argparse.ArgumentParser(description='Plot selected exp_002 scenarios.')
