"""
exp_007/plot_results.py  --  Publication figures for realistic fluence depth study.
...
OUT_ROOT    = os.path.join(r'C:\Users\SYAVAS-LASERLAB\Documents\LAB_PC_DRIVE', 'exp_007')
...
BURST_N_VALUES = list(range(10, 101, 10))

CONFIGS = [
    {'tag': 'ns',   'label': 'NS (1 ns, 1 J cm$^{-2}$)',
     'color': '#D95319', 'marker': 's', 'ls': '-',  'ms': 4},
    {'tag': 'fs',   'label': 'FS (100 fs, 0.1 J cm$^{-2}$)',
     'color': '#77AC30', 'marker': '^', 'ls': '-',  'ms': 4},
    {'tag': 'b030', 'label': 'Burst $N=30$',
     'color': '#0072BD', 'marker': 'o', 'ls': '-',  'ms': 3.5},
    {'tag': 'b060', 'label': 'Burst $N=60$',
     'color': '#7E2F8E', 'marker': 'D', 'ls': '-',  'ms': 3.5},
    {'tag': 'b100', 'label': 'Burst $N=100$',
     'color': '#A2142F', 'marker': 'v', 'ls': '-',  'ms': 3.5},
]
...
WAVEFORM_CONFIGS = [
    {'tag': 'ns',   'label': 'NS (1 ns)',       'color': '#D95319'},
    {'tag': 'fs',   'label': 'FS (100 fs)',      'color': '#77AC30'},
    {'tag': 'b100', 'label': 'Burst $N=100$',    'color': '#A2142F'},
]
...
ENHANCEMENT_DEPTHS = [0.5, 1.0, 2.0, 3.0]
ENHANCEMENT_COLORS = ['#0072BD', '#D95319', '#7E2F8E', '#77AC30']
...
def fig_enhancement_vs_N(cache):
    ...
    _legend(ax, loc='upper left', title='Depth', title_fontsize=6)
    return fig
...
def parse_args():
    p = argparse.ArgumentParser(description='Plot exp_007 results.')
